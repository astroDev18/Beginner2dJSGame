define(["Class", "ImageLoader", "SpriteSheet", "Animation"], function (
  Class,
  ImageLoader,
  SpriteSheet,
  Animation
  ...
  for (var i = 0; i < 10; i++) {
    var wrframe = {
      frame: player.sheet.crop(
        player.width * i,
        player.height * wrindex,
        player.width,
        player.height
      ),
      speed: frameduration,
  ...
  // Tree Asset
  var tree = new Assets("tree", "res/textures/tree_01.png", 725, 798);
